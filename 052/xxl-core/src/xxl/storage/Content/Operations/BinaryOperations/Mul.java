...
/*
 * Class that represents a multiplication.
 */
public class Mul extends BinaryOperations {

    public Mul(String address ,String input, Map<String,Cell> cells) {
    ...
    public String getValue(Map<String,Cell> cells) {
        ...
        if (getInvalidOperation() != null ) { return getInvalidOperation(); }        // if the multiplication is invalid, return #VALUE
        else {
